...
metadata {
	...
	definition (name: "Hue Bulb Fixed", namespace: "MikeMaxwell", author: "SmartThings") {
    ...
    details(["levelSliderControl","saturationSliderControl","hueSliderControl","level","saturation","hue","switch", "refresh"])
