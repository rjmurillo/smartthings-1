 ...
 */
 metadata {
	definition (name: "Fibaro Motion Sensor", namespace: "MikeMaxwell", author: "Todd Wackford") {
...
//added to support hub firmware update
...
def resetParams2StDefaults() {
	log.debug "Resetting Sensor Parameters to Maxwells Defaults"
	def cmds = []
	cmds << zwave.configurationV1.configurationSet(configurationValue: [10], parameterNumber: 1, size: 1).format()		//MOTION SENSOR’S SENSITIVITY  
    ...
    cmds << zwave.configurationV1.configurationSet(configurationValue: [255], parameterNumber: 14, size: 1).format()
    ...
    cmds << zwave.configurationV1.configurationSet(configurationValue: [0,0], parameterNumber: 40, size: 2).format()	//ILLUMINATION REPORT THRESHOLD
    cmds << zwave.configurationV1.configurationSet(configurationValue: [2,88], parameterNumber: 42, size: 2).format()	//ILLUMINATION REPORTS INTERVAL 
    cmds << zwave.configurationV1.configurationSet(configurationValue: [0], parameterNumber: 60, size: 1).format()		//TEMPERATURE REPORT THRESHOLD
    cmds << zwave.configurationV1.configurationSet(configurationValue: [2,88], parameterNumber: 62, size: 2).format()	//INTERVAL OF TEMPERATURE MEASURING
    cmds << zwave.configurationV1.configurationSet(configurationValue: [2,88], parameterNumber: 64, size: 2).format()	//TEMPERATURE REPORTS INTERVAL 
    cmds << zwave.configurationV1.configurationSet(configurationValue: [0,0], parameterNumber: 66, size: 2).format()	//TEMPERATURE OFFSET
    cmds << zwave.configurationV1.configurationSet(configurationValue: [0], parameterNumber: 80, size: 1).format()		//motion activated temp blinking 0=off
...
def listCurrentParams() {
    ...
    def cmds = []
    cmds << zwave.configurationV1.configurationGet(parameterNumber: 1).format() 	//motion sensitivity 
