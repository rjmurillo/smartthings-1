...
metadata {
	...
	definition (name: "Monoprice Doorbell Sensor", namespace: "MikeMaxwell", author: "Mike Maxwell") {
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2) {
			state "open", label: "Ding Dong!", icon: "st.security.alarm.alarm", backgroundColor: "#ffa81e"
...
def sensorValueEvent(value) {
	...
	if (value == 255) {
        ...
        createEvent(name: "contact", value: "open", descriptionText: "${device.displayName} went ding dong...")
	}
}
