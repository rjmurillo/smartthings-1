...
metadata {
	...
	definition (name: "Z-Wave Button", namespace: "MikeMaxwell", author: "Brian Dahlem") {
		capability "Button"
	...
	tiles {
		standardTile("button", "device.button", inactiveLabel: false, width: 2, height: 2) {
			...
			state "pushed", label: '', icon: "st.Home.home30", backgroundColor: "#b82121", action: "push"
		}
...
def sensorValueEvent(value) {
	if (value) {
    	...
    	sendEvent(name: "contact",value: "open",descriptionText:"$device.displayName is pushed",displayed: false,isStateChange: true)
		createEvent(name: "button", value: "pushed", descriptionText: "$device.displayName is pushed")
    }
}
//createEvent(name: "contact", value: "closed", descriptionText: "{$device.displayName is off}", displayed: false)
